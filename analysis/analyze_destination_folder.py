...
from config import DESTINATION_FOLDER_ID

# Set up logging
logging.basicConfig(filename='./reports/analyze_destination_folder_structure.log', level=logging.INFO, 
...
def view_source_structure():
    ...
    view_folder_contents(service, DESTINATION_FOLDER_ID)
